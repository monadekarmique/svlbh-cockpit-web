...
export const SOURCE_APACHE: SourceVideo = {
  ...
  langue: "EN",
  note:
    "La vidéo se termine en plein milieu de phrase (« Your brainstem watches CO2— ») : c'est la fin réelle de la Part 1. La Part 2 (4 min) est hébergée avec le programme « Garder le cap » (programmes-media/garder-le-cap/video-respiration-nasale-en-2.mov).",
  verbatim:
...
/** DEC débloquée par cette préparation — CONFIRMÉE par Patrick le 06.08. */
export const DEC_ATTRIBUTION_SERIE_EN =
  "Cette vidéo apache est mot pour mot la source de la session 1 de « Garder le cap » (porte du nez, NO des sinus, alarme CO2, gorgée d'eau = verrou) et l'élément Apache Runner du raccord Apache. DEC FERMÉE (Patrick 06.08) : la série vidéo EN est de @knowledge.for.you50 — attribution reportée en légende de la session 1 sur /programmes/st2/garder-le-cap (priv-web 84dc6b3).";
